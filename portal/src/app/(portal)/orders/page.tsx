...
export default function OrdersPage() {
  ...
  const loadOrders = useCallback(async () => {
    ...
    const distIds = [...new Set(allOrders.map((o) => o.distributor_id).filter(Boolean))] as string[];
    ...
    setOrders(
      allOrders.map((o) => ({
        ...
        distributor_name: o.distributor_id ? distMap.get(o.distributor_id) || null : null,
